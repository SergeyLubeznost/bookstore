...
if ($link === false) {
    ...
    $sql = "SELECT users.id, users.name, users.secondname, favorite__books.author, favorite__books.book__title, books__orders.id, books__orders.order__start, books__orders.order__end, books__orders.status FROM 
